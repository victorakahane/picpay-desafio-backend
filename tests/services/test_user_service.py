...
def test_create_user_existing_document(mock_user_service):
    ...
    with pytest.raises(UserAlreadyExistsException, match="User already exists with this document."):
...
def test_create_user_existing_email(mock_user_service):
    ...
    with pytest.raises(UserAlreadyExistsException, match="User already exists with this e-mail."):
        mock_user_service.create_user(user_data)
